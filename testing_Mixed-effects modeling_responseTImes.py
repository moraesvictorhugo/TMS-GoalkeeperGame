...
df_clean = df.dropna(subset=['response_time_info', 'context', 'response_info', 'last_was_error', 'ID_info'])
...
model = smf.mixedlm("response_time_info ~ context * response_info * last_was_error", df_clean, groups=df_clean['ID_info'])
...
plt.title("Predicted Response Time by Context and Response Info")
