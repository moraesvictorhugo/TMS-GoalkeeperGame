...
# Set times in seconds for the annotations
if detection_blocks == 'manual':
    marker_times_sec = [121.124, 1115.283,
                        1270.277, 2225.42,
                        2234.046, 3216.813,
                        3386.939, 4314.029,
                        4314.435, 5291.238, 
                        5374.866, 6302.179]  # Times in seconds
    ...
    # Get events from annotations based on manual markers
    signal_processing.split_events_into_blocks_manually(events_from_annot, split_value=10)
