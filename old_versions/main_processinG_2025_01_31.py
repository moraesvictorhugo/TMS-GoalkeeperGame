...
MEPpp_FDI_withExclusions_µV = MEPpp_FDI_withExclusions_V * 1000000
MEPpp_FDS_withExclusions_µV = MEPpp_FDS_withExclusions_V * 1000000
MEPpp_FDI_outGame_µV = MEPpp_FDI_outGame_V * 1000000
MEPpp_FDS_outGame_µV = MEPpp_FDS_outGame_V * 1000000
...
# MEP exclusion < 2 SD of mean out game
MEPpp_FDI_withExclusions_µV = utils.exclude_low_meps(MEPpp_FDI_outGame_µV, MEPpp_FDI_withExclusions_µV)
MEPpp_FDS_withExclusions_µV = utils.exclude_low_meps(MEPpp_FDS_outGame_µV, MEPpp_FDS_withExclusions_µV)
